...
- mô tả ngắn 1 đến 2 câu
- phần mở đầu nêu vấn đề
- phần nội dung chính chia thành các ý ngắn
...
- Nên phản ánh đúng thứ người đọc học được
...
- Dùng chữ thường
- Dùng dấu `-` để nối từ
- Không dùng dấu tiếng Việt trong URL/file
- Tên ngắn nhưng đủ nghĩa
...
- title và description không bị trùng vô nghĩa
- hình ảnh có đường dẫn đúng
